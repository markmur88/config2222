...
API_BASE_URL = os.getenv("DEUTSCHE_BANK_API_URL")
DEUTSCHE_BANK_API_URL = os.getenv("DEUTSCHE_BANK_API_URL")
DEUTSCHE_BANK_CLIENT_ID = os.getenv("DEUTSCHE_BANK_CLIENT_ID")
DEUTSCHE_BANK_CLIENT_SECRET = os.getenv("DEUTSCHE_BANK_CLIENT_SECRET")

MEMO_BANK_API_URL = os.getenv("MEMO_BANK_API_URL")
MEMO_BANK_CLIENT_ID = os.getenv("MEMO_BANK_CLIENT_ID")
MEMO_BANK_CLIENT_SECRET = os.getenv("MEMO_BANK_CLIENT_SECRET")
